...
Func saveSettings()
	...
	If Not FileExists($settingspath) Then
		...
		IniWrite($settingspath, "OVERLAY", "Poition", "0")
		IniWrite($settingspath, "OVERLAY", "Transparency", "0")
	...
	; Save To File
	; IniWrite(@ScriptDir & "\Settings\Settings.ini", "Bot Settings", "DebugTolTip", $g_bDebugToolTipOn)

EndFunc

Func loadSettings()
	If Not FileExists($settingspath) Then
		debug("NoSettingsFile")
		Return
	EndIf

	;READ FILE
	; $LumaTime = (IniRead(@ScriptDir & "\Settings\BotEncounter.ini", "BotEncounter", "LumaTime", "0"))
	;SET GUI
	; GUICtrlSetData($GUI_EncounterNum, $g_iEncounter)
